...
class OrderActiveListComponent extends React.Component {
    ...
    componentDidMount(){
        OrderService.getOrderActiveListForCurrentUser().then((response) => {
    ...
    render (){
        return (
            <div>
                ...
                <button className="btn btn-outline-warning float-right" onClick={() => this.completedOrders()}>Completed orders</button>
                <br/><br/>
                {
...
export default OrderActiveListComponent